    ...
    try:
        ...
        with open(was_xml_path+'rtde_was_meta.xml','w',encoding='utf-8') as file :
            ...
            for idx in range(len(was_rtde_meta_group_df)) :
                was_rtde_meta_group_df.loc[idx,'pgm_grp_desc'] = make_cdata(str(DecryptFile.decrypt(was_rtde_meta_group_df['pgm_grp_desc'][idx])))
            ...
            for idx in range(len(was_rtde_meta_pgm_df)) :
                was_rtde_meta_pgm_df.loc[idx,'pgm_desc'] = make_cdata(str(DecryptFile.decrypt(was_rtde_meta_pgm_df['pgm_desc'][idx])))
